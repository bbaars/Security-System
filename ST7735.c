...
uint32_t ST7735_DrawString(uint16_t x, uint16_t y, char *pt, int16_t textColor, uint16_t backgroundColor, uint8_t size){
	uint32_t count = 0;
	if(y>160) return 0;
	while(*pt){
		ST7735_DrawCharS(x, y, *pt, textColor, backgroundColor, size);
		pt++;
		x = x + (size*6);
...
void ST7735_OutUDec(uint32_t n){
  ...
  ST7735_DrawString(StX,StY,Message,StTextColor, ST7735_WHITE, 1);
...
void ST7735_OutChar(char ch){
  if((ch == 10) || (ch == 13) || (ch == 27)){
    ...
    ST7735_DrawString(0,StY,"                     ",StTextColor, ST7735_WHITE, 1);
    return;
  }
